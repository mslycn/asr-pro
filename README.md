...
| 名称 | 型号 | 数量 | PCB标注 | 链接 |
| ----- | ----- | ----: | :----: | :----: |
| ASR-PRO语音智能识别控制开发板 [交易快照]
颜色分类：ASRPRO开发板2M闪存（排针已焊）+下载线+喇叭 | 颜色很多 | 1 | LED | [购买](https://item.taobao.com/item.htm?spm=a1z09.2.0.0.33932e8dA9Txy3&id=684816007765&_u=o1ed9uja9df&skuId=4996244009332) |
